          ...
          <div className="flex flex-col gap-4">
            {trending.map((resource) => (
              <Link
                href={`/resources/${resource.slug}`}
                key={resource.id}
                className="flex items-center justify-between p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group border border-transparent hover:border-cyan-500/30"
              >
                <div>
