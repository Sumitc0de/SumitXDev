      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {recommendations.map((resource, idx) => (
          <motion.a
            ...
            className="group block p-6 rounded-2xl bg-gradient-to-br from-[#0f172a] to-[#020617] border border-purple-500/20 hover:border-purple-400/60 shadow-lg hover:shadow-purple-500/20 transition-all duration-300"
          >
