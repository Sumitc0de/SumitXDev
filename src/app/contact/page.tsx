        ...
        <main className="bg-[#020617] text-white">
            ...
            <section className="relative overflow-hidden pt-28 pb-20 sm:pb-24">
                ...
                <div className="mx-auto max-w-6xl px-6">
                    ...
                    <p className="mt-6 max-w-2xl text-sm sm:text-base md:text-lg text-gray-400">
                        You’re one message away from building AI-powered systems, automations,
            ...
            <section className="pb-32">
                <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
                    ...
                    <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-[#0b1220] via-[#0e1628] to-[#101a2e] p-6 sm:p-7 backdrop-blur-xl flex flex-col md:h-[560px]">
                        ...
                        {/* Metrics */}
                        <div className="mb-4 grid grid-cols-3 gap-4 border-y border-white/10 py-3">
                            <div>
                        ...
                        <div className="mt-auto pt-4 border-t border-white/10 flex flex-col sm:flex-row gap-3">
                            ...
                            {/* <Link
                href="/services"
                className="flex-1 rounded-lg border border-white/20 px-4 py-2 text-center text-sm transition hover:border-purple-400 hover:text-purple-400"
              >
                View Services
              </Link> */}
                        </div>
